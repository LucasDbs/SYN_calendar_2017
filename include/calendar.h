...
int employee_print(employee_t *, char **);
...
int bubname_employee(employee_t *, char **);
int bubforename_employee(employee_t *, char **);
int bubjob_employee(employee_t *, char **);
int bubzip_employee(employee_t *, char **);
